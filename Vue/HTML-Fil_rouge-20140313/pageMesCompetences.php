								...
								<article class="recherche">
									...
									<form id="formulaire" method="post" action="traitement.php>	
										...
										<div id="formcomp"><form>
											<input type="radio" name="choix" value="SQL"><span id="boutonradio">Langage SQL</span></br>
											<input type="radio" name="choix" value="postgre"><span id="boutonradio">PostgreSQL</span></br>
											<input type="radio" name="choix" value="mysql"><span id="boutonradio">MySQL</span></br>
										</form>
										</div>
									...
									<aside>
					<a id="boutonProjet" href="pageProjets.php"><img src="images/image.png" alt="logo_prop" title="cliquez"/></a>
				</aside>
				</div>
