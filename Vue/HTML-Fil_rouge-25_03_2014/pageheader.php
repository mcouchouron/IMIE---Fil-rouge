...
<div id="identification">
		...
		<img id ="pictoUser" src="images/pictoUtilisateur.png"/>
...
<nav>
	<div id="boutonhome">
		<a id="boutonhome" href="pageAccueil.php">| Home |</a>
	</div>
		<div id="boutonprojet">
			<a id="boutonprojet" href="pageProjets.php">| Projets |</a>
		</div>
			<a id="boutoncompetences" href="pageCompetences.php">| Compétences |</a>
			<a id="boutonutilisateurs" href="pageUtilisateurs.php">| Utilisateurs |</a>
</nav>
</div>